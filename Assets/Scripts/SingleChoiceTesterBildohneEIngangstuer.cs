...
public class SingleChoiceTesterBildohneEIngangstuer : MonoBehaviour
{
    ...
    public LernraumLogik_ohneEingangstuer verknüpfungLogik;
    public OpenQuestionElementohneEingangstuer questionelementVerfaerben;
